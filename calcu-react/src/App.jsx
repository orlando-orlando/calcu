...
export default function App() {
  ...
  const perdidaTuberia       = datosPorSistema?.calentamiento?.perdidasBTU?.tuberia     ?? 0; // ← NUEVO
            ...
            <table className="tabla-resultados">
              <tbody>
                ...
                <tr>
                  ...
                  <td>{sistemaListoCalor ? formatBTU(perdidaEvaporacion) : "—"}</td>
                </tr>
                <tr>
                  <th>Pérdida por convección:</th>
                  <td>{sistemaListoCalor ? formatBTU(perdidaConveccion) : "—"}</td>
                </tr>
                <tr>
                  <th>Pérdida por radiación:</th>
                  <td>{sistemaListoCalor ? formatBTU(perdidaRadiacion) : "—"}</td>
                </tr>
                <tr>
                  <th>Pérdida por transmisión:</th>
                  <td>{sistemaListoCalor ? formatBTU(perdidaTransmision) : "—"}</td>
                </tr>
                <tr>
                  <th>Pérdida por tubería:</th>
                  <td>{sistemaListoCalor ? formatBTU(perdidaTuberia) : "—"}</td>
                </tr>
                <tr>
                  <th>Pérdida por infinity:</th>
                  <td>{sistemaListoCalor ? formatBTU(perdidaInfinity) : "—"}</td>
                </tr>
                <tr>
                  <th>Pérdida por canal perimetral:</th>
                  <td>{sistemaListoCalor ? formatBTU(perdidaCanal) : "—"}</td>
                </tr>
                <tr>
                  <th>Pérdida total de calor:</th>
                  <td>{sistemaListoCalor ? formatBTU(perdidaTotalBTU) : "—"}</td>
                </tr>
